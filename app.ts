...
let Ffruits:string[] = ["apple" , "orange", "watermelon", "Kiwi"]
...
let Fruitss:string[] = ["apple" , "orange", "watermelon"]
Fruitss.shift()
console.log(Fruitss);   //[ 'orange', 'watermelon' ]

//unshift() method adds one or more elements to the beginning of an array and returns the new length of the array.
let fruit1:string[] = ["apple" , "orange", "watermelon"]
fruit1.unshift("apple")
console.log(fruit1);   //[ 'apple', 'apple', 'orange', 'watermelon' ] */

let Fruits1:string[] = ["apple" , "orange", "watermelon"]
Fruits1.pop()
Fruits1.pop()
Fruits1.pop()
console.log(Fruits1)   //[]

let fruited:string[] = ["apple" , "orange", "watermelon"]
fruited.shift()
fruited.shift()
fruited.shift()
console.log(fruited)   //[]
